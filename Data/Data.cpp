//
// Created by Administrator on 2022/7/5 0005.
//
...
namespace MLPP{
    ...
    std::tuple<std::vector<std::vector<double>>, std::vector<double>> Data::loadBreastCancerSVC(){
        ...
        setData(BREAST_CANCER_SIZE, "D:\\untitled\\Data\\Datasets\\BreastCancerSVM.csv", inputSet, outputSet);
        return {inputSet, outputSet};
    }
    ...
    std::tuple<std::vector<std::vector<double>>, std::vector<double>> Data::loadCaliforniaHousing(){
        ...
        setData(CALIFORNIA_HOUSING_SIZE, "D:\\untitled\\Data\\Datasets\\CaliforniaHousing.csv", inputSet, outputSet);
        return {inputSet, outputSet};
    }
    ...
    std::tuple<std::vector<double>, std::vector<double>> Data::loadFiresAndCrime(){
        ...
        setData("D:\\untitled\\Data\\Datasets\\FiresAndCrime.csv", inputSet, outputSet);
        return {inputSet, outputSet};
    }
